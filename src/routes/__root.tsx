  ...
  head: () => ({
    meta: [
      ...
      { title: "kanyoai — AI website builder" },
      {
        name: "description",
        content:
          "Describe any website. kanyoai builds it in clean HTML, CSS, and JavaScript — ready to download and host anywhere.",
      },
      { name: "author", content: "kanyoai" },
    ...
    links: [
      ...
      { rel: "apple-touch-icon", href: "/assets/kanyoai-logo.svg" },
